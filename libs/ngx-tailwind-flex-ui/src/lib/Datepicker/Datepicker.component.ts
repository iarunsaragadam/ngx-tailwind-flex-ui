import {Component, Input, Output, EventEmitter, ViewChild, ElementRef, forwardRef, HostListener} from '@angular/core';
...
export class DatepickerComponent implements ControlValueAccessor {
  ...
  isDisabled(date: Date): boolean {
    if ((this.minDate && date < this.minDate) || (this.maxDate && date > this.maxDate)) return true;
